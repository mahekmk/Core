...
<script type="text/javascript">
	function url(ele) 
	{
		...
		var page = ele.value;
		var pageUrl = "<?php echo $this->getUrl('grid','page',['p' => $this->getPager()->getStart()],true) ?>&rpp="+ele.value;
...
<button name='Add'><a href="<?php echo $this->getUrl('add','page',['p' => $this->getPager()->getEnd()],false) ?>">Add</a></button>
<table border="1" width="100%" cellspacing="4">
	...
	<?php else : ?>
		...
		<tr>
			...
			<td><a href="<?php echo $this->getUrl('edit','page',['id'=> $page->pageId ],false) ?>">Edit</a></td>
			<td><a href="<?php echo $this->getUrl('delete','page',['id'=> $page->pageId ],false) ?>">Delete</a></td>
		</tr>
		<?php endforeach;	?>
<?php endif;  ?>
</table>
