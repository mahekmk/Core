...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $this->getUrl('grid','salesman',['p' => $this->getPager()->getStart()],true) ?>&rpp="+ele.value;
...
<?php endif;?>
		...
		<button name='Add'><a href="<?php echo $this->getUrl('add','salesman',['p' => $this->getPager()->getEnd()],false) ?>">Add</a></button>
		<table border="1" width="100%" cellspacing="4">
			...
			<?php else : ?>
				...
				<tr>
					...
					<td><a href="<?php echo $this->getUrl('edit','salesman',['id'=> $salesman->salesmanId],false) ?>">Edit</a></td>
					<td><a href="<?php echo $this->getUrl('delete','salesman',['id'=> $salesman->salesmanId],false) ?>">Delete</a></td>
				</tr>
				<?php endforeach;	?>
		<?php endif;  ?>
		</table>
