...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $this->getUrl('grid','config',['p' => $this->getPager()->getStart()],true) ?>&rpp="+ele.value;
...
<?php endif;?>
		...
		<button name='Add'><a href="<?php echo $this->getUrl('add','config',['p' => $this->getPager()->getEnd()],false) ?>">Add</a></button>
		<table border="1" width="100%" cellspacing="4">
			...
			<?php else : ?>
				...
				<tr>
					...
					<td><a href="<?php echo $this->getUrl('edit','config',['id'=> $config->configId],false) ?>">Edit</a></td>
					<td><a href="<?php echo $this->getUrl('delete','config',['id'=> $config->configId],false) ?>">Delete</a></td>
				</tr>
				<?php endforeach;	?>
		<?php endif;  ?>
		</table>
