...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $this->getUrl('grid','vendor',['p' => $this->getPager()->getStart()],true) ?>&rpp="+ele.value;
...
<button name='Add'><a href="<?php echo $this->getUrl('add','vendor',['p' => $this->getPager()->getEnd()],false) ?>">Add</a></button>
<table border="1" width="100%" cellspacing="4">
	...
	<?php else : ?>
		...
		<tr>
			...
			<td><a href="<?php echo $this->getUrl('edit','vendor',['id'=> $vendor->vendorId],false) ?>">Edit</a></td>
			<td><a href="<?php echo $this->getUrl('delete','vendor',['id'=> $vendor->vendorId],false) ?>">Delete</a></td>
		</tr>
		<?php endforeach;	?>
<?php endif;  ?>
</table>
