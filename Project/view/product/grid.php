...
<script type="text/javascript">
	...
	{
		var page = ele.value;
		var pageUrl = "<?php echo $controllerCoreAction->getUrl('grid','product',['p' => $this->getPager()->getStart()],true) ?>&rpp="+ele.value;
...
<?php endif;?>
		...
		<button name='Add'><a href="<?php echo $controllerCoreAction->getUrl('add','product',['p' => $this->getPager()->getEnd()],false) ?>">Add</a></button>
			...
			<?php else : ?>
				...
				<tr>
					...
					<td><?php if(!$product->thumbImage): echo "No image Selected"?>
						...
						<?php endif;?></td>
					<td><a href="<?php echo$controllerCoreAction->getUrl('edit','product',['id' =>  $product->productId],false) ?>">Edit</a></td>
					<td><a href="<?php echo$controllerCoreAction->getUrl('delete','product',['id' =>  $product->productId],false) ?>">Delete</a></td>
					<td><a href="<?php echo$controllerCoreAction->getUrl('grid','product_media',['id' =>  $product->productId],false) ?>">Media</a></td>
				</tr>
				<?php endforeach;	?>
		<?php endif;  ?>
		</table>
